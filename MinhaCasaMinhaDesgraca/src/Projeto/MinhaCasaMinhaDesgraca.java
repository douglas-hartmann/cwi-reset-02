...
public class MinhaCasaMinhaDesgraca {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Endereco endereco2 = new Endereco("Albano Hansen",156,0,"Sete de Setembro","Sao Paulo",UnidadeFederativa.SAOPAULO);
        Endereco endereco3 = new Endereco("Tiradentes",188,203,"Centro","Canoas",UnidadeFederativa.RIOGRANDEDOSUL);
        Endereco endereco4 = new Endereco("José de Alencar",1544,0,"Menino Deus","Ivoti",UnidadeFederativa.RIOGRANDEDOSUL);
        Endereco endereco5 = new Endereco("Presidente Lucena",23678,2,"Travessão","Dois Irmaos",UnidadeFederativa.RIODEJANEIRO);
        System.out.println("estadoo" + endereco1.getEstado());
        Imovel imovel1 = new Imovel(endereco1,105000);
